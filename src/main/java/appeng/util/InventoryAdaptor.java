...
import com.gamerforea.ae.AdaptorInventoryLargeChest;
...
public abstract class InventoryAdaptor implements Iterable<ItemSlot>
{
	...
	public static InventoryAdaptor getAdaptor(final Object te, final ForgeDirection d)
	{
		...
		if (te instanceof TileEntityChest)
		{
			...
			IInventory inventory = Platform.GetChestInv(te);
			return (EventConfig.doubleChestDupeFix || EventConfig.globalChunkDupeFix) && inventory instanceof InventoryLargeChest ? new AdaptorInventoryLargeChest((InventoryLargeChest) inventory) : new AdaptorIInventory(inventory);
