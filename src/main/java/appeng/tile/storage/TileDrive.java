...
public class TileDrive extends AENetworkInvTile implements IChestOrDrive, IPriorityHost
{
	...
	{
		return !EventConfig.chestDriveDenyAutoInsertExtract && super.canInsertItem(slotIndex, insertingItem, side);
	}

	@Override
	public boolean canExtractItem(int slotIndex, ItemStack extractedItem, int side)
	{
		return !EventConfig.chestDriveDenyAutoInsertExtract && super.canExtractItem(slotIndex, extractedItem, side);
	}
