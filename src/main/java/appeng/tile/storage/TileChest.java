		...
		implements IMEChest, IFluidHandler, ITerminalHost, IPriorityHost, IConfigManagerHost, IColorableTile
{
	...
	public boolean isPowered()
	{
		...
		return this.getAECurrentPower() > 1 || gridPowered;
	}
	...
	public boolean canInsertItem(final int slotIndex, final ItemStack insertingItem, final int side)
	{
		if (slotIndex == 1)
		{
			...
			if (EventConfig.chestDriveDenyAutoInsertExtract)
				return false;
			// TODO gamerforEA code end

			ICellRegistry cellRegistry = AEApi.instance().registries().cell();
			if (cellRegistry.getCellInventory(insertingItem, this, StorageChannel.ITEMS) != null)
				return true;
			return cellRegistry.getCellInventory(insertingItem, this, StorageChannel.FLUIDS) != null;
		}
		else
			try
			{
