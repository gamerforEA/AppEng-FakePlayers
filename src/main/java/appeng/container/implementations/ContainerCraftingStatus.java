...
public class ContainerCraftingStatus extends ContainerCraftingCPU
{
	...
	{
		IGrid grid = this.getNetwork();

		/* TODO gamerforEA code code replace, old code:
		final ICraftingGrid cc = grid.getCache(ICraftingGrid.class);
		final ImmutableSet<ICraftingCPU> cpuSet = cc.getCpus(); */
		final ICraftingGrid cc = grid == null ? null : grid.getCache(ICraftingGrid.class);
		final ImmutableSet<ICraftingCPU> cpuSet = cc == null ? ImmutableSet.of() : cc.getCpus();
